...
SELECT "subscribers".* FROM "subscribers" LEFT OUTER JOIN "taggings" ON "taggings"."subscriber_id" = "subscribers"."id" WHERE "taggings"."tag_id" IN (1, 2) AND ("taggings"."tag_id" NOT IN (1, 2) OR "taggings"."tag_id" IS NULL)
      SQL
    end
  end
end
